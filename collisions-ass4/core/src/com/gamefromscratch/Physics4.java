...
public class Physics4 extends ApplicationAdapter {
    ...
    public void create() {
        ...
        sprite2.setPosition(-sprite.getWidth()/2,-sprite.getHeight()/2 + 400);
        ...
        world.setContactListener(new ContactListener() {
            ...
            public void beginContact(Contact contact) {
                ...
                if((contact.getFixtureB().getBody() == body2) || (contact.getFixtureB().getBody() == bodyEdgeScreen)) {
    ...
    public void render() {
        ...
        sprite.setPosition((body.getPosition().x * PIXELS_TO_METERS - 50) - sprite.
                        getWidth()/2 ,
                (body.getPosition().y * PIXELS_TO_METERS) -sprite.getHeight()/2 );


        sprite.setRotation((float)Math.toDegrees(body2.getAngle()));
        sprite2.setPosition((body2.getPosition().x * PIXELS_TO_METERS + 100) - sprite2.
                        getWidth()/2 ,
